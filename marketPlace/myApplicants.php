...
try{ $dbc = new PDO($ls->db_host, $ls->db_usn, $ls->db_psw,array(PDO::ATTR_PERSISTENT => true));
 ...
 $loanCode = filter_input(INPUT_GET, 'loanCode');
?>
<html lang="en"><head>
      ...
      <div class="container">
        ...
        <div>
            <table class="table table-responsive table-striped">
                ...
                <tbody>
                    <?php 
                    $stmt = "SELECT * FROM LENDR_MKT_001 WHERE ACTIVE_YN = 'Y' AND LEND_BORROW_CODE = 1 AND LOAN_CODE='$loanCode'";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dropdown">
                                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">Action</button>
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">                                <li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="#">Get Report</a>
                                    </li>
                                    <li role="presentation">
                                        <a role="menuitem" tabindex="-1" href="#">Approve</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
