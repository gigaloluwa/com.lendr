      ...
      <div class="container">
        ...
        <div>
            <table class="table table-responsive table-striped">
                ...
                <tbody>
                    <?php 
                    $stmt = "SELECT * FROM LENDR_MKT_001 WHERE ACTIVE_YN = 'Y' AND PROC_CODE = 0";
                    ...
                    ?>
                    <tr>
                        <td><?php echo strtoupper($header['SEGMENT']); ?></td>
                        <td><?php echo number_format($header['AMOUNT'], 0, ".", ","); ?></td>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                                    Action
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">                               <?php if ($_SESSION["USER_ID"] != $header['LENDR_CODE']){
                                          echo  '<li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="./borrow.php?loanCode='.$header['LOAN_CODE'].'&rate='.$header['RATE'].'&tenor='.$header['TENOR'].'&purpose='.$header['PURPOSE'].'&segment='.$header['SEGMENT'].'&amount='.$header['AMOUNT'].'">Borrow</a>
                                        </li>';}?>
