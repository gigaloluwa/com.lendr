      ...
      <div class="container">
        ...
        <div class="container">
           ...
           try{
               ...
               $dbc->exec("INSERT INTO LENDR_LOGIN_DTL (EMAIL,USR_CODE,PASSWORD,OTHER_NAMES) VALUES ('$email',$user_code,md5('$psw'),'$otherNames')");
               $dbc->commit();
               ?>
            <h2>REGISTRATION COMPLETE. PLEASE SIGN IN <A HREF="../pages/signin.php">HERE</a></h2>
